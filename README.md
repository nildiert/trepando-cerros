...
Además considera el desgaste del cuerpo: a medida que se acumulan kilómetros se aplica un pequeño factor de fatiga que incrementa ligeramente el tiempo estimado. La fatiga se divide en dos indicadores: los gemelos se cansan en las subidas y los cuádriceps en las bajadas. Para evitar tiempos exagerados, los coeficientes de fatiga se redujeron para que cada metro ascendido o descendido tenga un efecto más moderado sobre el ritmo.
